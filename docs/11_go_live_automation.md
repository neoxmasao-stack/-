...
make verify-docs
```
- 01〜10 + 12/13/14 + FIN-OS_ORG_OPERATING_MODEL + 15 + 16 + 17 + 18 + 19 + 20 + 21 + 22 + 23 + 25 + 26 の存在を確認
...
```
- 外部接続（銀行API/RTGS/CBDC/Card/ATM/SIEM）の全行程確認。
...
```
- Go-Live / Grand-Open / 法務クリーン / 文書整合を統合確認。
...
- D. Legal / Regulatory
  ...
  - D8. external connectivity full-process validation
- E. Audit / Compliance
